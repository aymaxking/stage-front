...
export class CatalogueService {
  ...
  public getUtilisateurBy(id:string,poste:string,type:string,matricule:string,page:number,size:number){
    if(id==""||id==null)
      return this.httpClient.get(this.host+"/utilisateurs/search/by?poste="+poste+"&type="+type+"&matricule="+matricule+"&page="+page+"$size="+size)
